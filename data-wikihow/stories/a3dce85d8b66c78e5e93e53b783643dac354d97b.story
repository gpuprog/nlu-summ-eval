...
Consider rotating the eggshell every few days. This will allow the plants to get equal amounts of sunlight and grow more evenly.You may need to pull out the smaller/weaker seedlings so that each eggshell has one plant growing in it. This will ensure that the young seedlings enough space to grow in.
