...
You can only downgrade to the level that you have these files for . So , capture your version 6 files and you can use them when version 7 comes along , etc. iFaith has an option to use someone else 's files , however , so if you do n't have the files saved you can use that program .
